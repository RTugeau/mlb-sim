...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        Team BAL = new Team("Orioles", 0, 0, 62, 0, 0);
        Team NYY = new Team("Yankees", 0, 0, 50, 0, 0);
        Team TOR = new Team("Blue Jays", 0, 0, 54, 0, 0);
        Team BOS = new Team("Red Sox", 0, 0, 48, 0, 0);
        Team TB = new Team("Rays", 0, 0, 61, 0, 0);
        Team WSH = new Team("Nationals", 0, 0, 44, 0, 0);
        Team NYM = new Team("Mets", 0, 0, 46, 0, 0);
        Team ATL = new Team("Braves", 0, 0, 64, 0, 0);
        Team PHI = new Team("Phillies", 0, 0, 56, 0, 0);
        Team MIA = new Team("Marlins", 0, 0, 52, 0, 0);
        Team CWS = new Team("White Sox", 0, 0, 38, 0, 0);
        Team CLE = new Team("Guardians", 0, 0, 47, 0, 0);
        Team MIN = new Team("Twins", 0, 0, 54, 0, 0);
        Team DET = new Team("Tigers", 0, 0, 48, 0, 0);
        Team KC = new Team("Royals", 0, 0, 35, 0, 0);
        Team STL = new Team("Cardinals", 0, 0, 44, 0, 0);
        Team MIL = new Team("Brewers", 0, 0, 57, 0, 0);
        Team PIT = new Team("Pirates", 0, 0, 47, 0, 0);
        Team CIN = new Team("Reds", 0, 0, 51, 0, 0);
        Team CHC = new Team("Cubs", 0, 0, 47, 0, 0);
        Team LAA = new Team("Angels", 0, 0, 45, 0, 0);
        Team HOU = new Team("Astros", 0, 0, 56, 0, 0);
        Team OAK = new Team("Athletics", 0, 0, 31, 0, 0);
        Team TEX = new Team("Rangers", 0, 0, 56, 0, 0);
        Team SEA = new Team("Mariners", 0, 0, 54, 0, 0);
        Team LAD = new Team("Dodgers", 0, 0, 62, 0, 0);
        Team SF = new Team("Giants", 0, 0, 49, 0, 0);
        Team SD = new Team("Padres", 0, 0, 51, 0, 0);
        Team COL = new Team("Rockies", 0, 0, 36, 0, 0);
        Team ARI = new Team("Diamondbacks", 0, 0, 52, 0, 0);
